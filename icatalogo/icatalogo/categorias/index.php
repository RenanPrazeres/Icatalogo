<?php
// inporta o banco de dados
require("../database/conexao.php");
//declara o sql do select 
...
<body>
        ...
        <section class="categorias-container"> 
            <main>
                ...
                if(mysqli_num_rows($resultado) == 0){
                    echo "<p style='text-aling: center'>Nenhuma categoria Cadastrada.</p>";
                }
    ...
    <script lang="javaScript">
        function deletar(categoriaId){
            document.querySelector("3categoriaId").value = categoriaId;
